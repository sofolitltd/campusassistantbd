...
import '/auth/get_verification_code_screen.dart';
import '/auth/new_teacher_signup_screen.dart';
                        ...
                        children: [
                          ...
                          CommonTextFieldWidget(
                            ...
                            validator: (val) {
                              ...
                              if (val.length != 8) {
                                return 'Verification code must be 8 digit';
                              }
                              return null;
                            },
                          ),
                                            ...
                                            MaterialPageRoute(
                                              builder: (context) {
                                                return NewTeacherSignupScreen(
                                                  ...
                                                  //todo: need to add verificationUId
                                                );
                                              },
                                            ),
                                          );
