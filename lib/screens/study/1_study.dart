import 'package:campusassistant/screens/study/syllabus/full_syllabus.dart';
...
import 'archive/research/research.dart';
  ...
  getBatches() async {
    ...
    await ref.get().then((snap) {
      for (var data in snap.docs) {
        ...
        //
        if (widget.screenFor == 'admin') {
          _selectedBatch = batches.first;
        } else {
          if (widget.profileData.information.batch == '') {
            _selectedBatch = batches.first;
          } else {
            _selectedBatch = widget.profileData.information.batch;
          }
        }
      }
    });
    ...
    return Scaffold(
      ...
      floatingActionButton:
          ((widget.profileData.information.status!.moderator! == true ||
                      widget.profileData.information.status!.admin! == true) &&
                  batches != [])
              ? FloatingActionButton(
                  onPressed: () {
                    Navigator.push(
                                ...
                                return GestureDetector(
                                  ...
                                  onLongPress: () {
                                    if (widget.profileData.information.status!
                                                .moderator! ==
                                            true ||
                                        widget.profileData.information.status!
                                                .admin! ==
                                            true) {
                                      // edit semester
                                      Navigator.push(
