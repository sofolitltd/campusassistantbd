...
class _EditStaffState extends State<EditStaff> {
  ...
  @override
  void initState() {
    _selectedSerial = widget.staffModel.serial.toInt();
    _postController.text = widget.staffModel.post;
    _nameController.text = widget.staffModel.name;
    _phoneController.text = widget.staffModel.phone;
    super.initState();
  }
                  ...
                  onPressed: _isLoading
                      ...
                      : () async {
                          if (_globalKey.currentState!.validate()) {
                            ...
                            downloadedUrl = widget.staffModel.imageUrl;
                            ...
                            if (_pickedMobileImage != null) {
                              ...
                              // delete old image
                              if (widget.staffModel.imageUrl != "") {
                                await FirebaseStorage.instance
                                    .refFromURL(widget.staffModel.imageUrl)
                                    .delete()
                            ...
                            // update
                            await ref.update(staffModel.toJson()).then((value) {
