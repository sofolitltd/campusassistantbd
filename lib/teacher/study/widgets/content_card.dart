...
import 'package:campusassistant/teacher/study/upload/content_edit.dart';
import 'package:campusassistant/teacher/study/widgets/pdf_viewer_web.dart';
...
import '/teacher/study/widgets/bookmark_button.dart';
      ...
      child: Column(
        children: [
          ...
          InkWell(
            ...
            // todo
            onLongPress: () {
              if (widget.profileData.information.status!.admin! ||
                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          //code
                          Text(
                            widget.contentModel.contentType == "Notes"
